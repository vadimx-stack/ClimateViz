...
<div align="center">
    <img src="https://via.placeholder.com/800x400?text=ClimateViz+Dashboard" alt="ClimateViz Preview" width="80%"/>
    <p><i>Интерактивная платформа для визуализации и анализа климатических данных.</i></p>
</div>
